...
function showSelectedDate() {
    ...
    datePicker.textContent = selectedDate.toLocaleDateString("ja-JP", options);
}
...
function changePage(){
    ...
    //textareaにチェックボックスにチェックした項目を追加
    document.getElementById("emailContent").value =
    " 依頼元会社&種類 : " + inputCompany + '\n' +
    "  依頼元グループ : " + inputGroupPPES + inputGroupTMC + '\n' +
    "     依頼者     : " + inputRequester + '\n' +
    "     依頼先     : " + inputReceiveGroup + '\n' +
